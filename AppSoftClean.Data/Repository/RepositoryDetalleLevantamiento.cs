...
{
    public class RepositoryDetalleLevantamiento : IDetalleLevantamientoRepository
    {
        ...
        public bool ActualizarDetalles(DetalleLevantamiento Detalles)
        {
            ...
            try
            {
                DetalleLevantamiento detallesObj = conn.DetalleLevantamiento.Where(c => c.Id == Detalles.Id).FirstOrDefault<DetalleLevantamiento>();
        ...
        public List<DetalleLevantamiento> GetDetallesByID(int id)
        {
            ...
            try
            {
                levantamientoObj = conn.DetalleLevantamiento.Where(c => c.Id == id).ToList<DetalleLevantamiento>();
            }
            catch (Exception ex)
            {
