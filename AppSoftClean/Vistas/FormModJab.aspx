<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormModJab.aspx.cs" Inherits="AppSoftClean.Vistas.FormAreaUso" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-lg-12">
            <h1>Modelo Jabonera <span class="badge bg-secondary">Nuevo</span></h1>
        </div>
    </div>
