<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormCepInBas.aspx.cs" Inherits="AppSoftClean.Vistas.FormAreaUso" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-lg-12">
            <h1>Cepillo, Inserto y Base <span class="badge bg-secondary">Nuevo</span></h1>
        </div>
    </div>
