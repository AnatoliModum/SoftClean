<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormModJab.aspx.cs" Inherits="AppSoftClean.Vistas.FormModJab" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-lg-12">
            <h1>Modelo Jabonera <span class="badge bg-secondary"><asp:Label ID="lblAccion" runat="server" Text="Accion"></asp:Label></span></h1>
        </div>
    </div>
    <div class="panel panel-info panel-inicial">
        ...
        <div class="panel-body">
            <div class="row">
                <div class="col-lg-4">
                    <asp:RequiredFieldValidator ID="rfvModelo" runat="server" ValidationGroup="VDModJab"
                ...
                <div class="col-lg-5">
                    <asp:RequiredFieldValidator ID="rfvStock" runat="server" ValidationGroup="VDModJab"
                        ControlToValidate="TextStock"
                        ErrorMessage="El Número de Stock es Requerido"
                        ForeColor="Red">
                    </asp:RequiredFieldValidator>
                </div>
            </div>
            <div class="row">
                ...
                <div class="col-lg-1">
                    <asp:Button ID="btnGuardar" class="btn btn-success" runat="server" Text="Guardar" OnClick="btnGuardar_Click" ValidationGroup="VDModJab" />
                </div>
                <div class="col-lg-2">
            ...
            <div class="row">
                ...
                <div class="col-lg-5">
                    <asp:RegularExpressionValidator ID="revStock" runat="server" ValidationGroup="VDModJab"
