<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="FormDosEstLim.aspx.cs" Inherits="AppSoftClean.Vistas.FormAreaUso" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <div class="row">
        <div class="col-lg-12">
            <h1>Dosificador Estación de Limpieza <span class="badge bg-secondary">Nuevo</span></h1>
        </div>
    </div>
