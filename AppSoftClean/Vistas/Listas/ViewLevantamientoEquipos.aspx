                ...
                <div class="form-horizontal form-label-left input_mask">
                    <asp:GridView ID="dgvDatos" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="División" DataField="IdDivision" ItemStyle-Font-Size="10" />
                            <asp:BoundField HeaderText="Fecha" DataField="dteFecha" ItemStyle-Font-Size="10" />
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>Confirme para eliminar el registro número&nbsp<span class="label label-danger"><asp:Label ID="lblID" runat="server" Text="Label"></asp:Label></span>&nbsp llamado &nbsp<span class="label label-danger"><asp:Label ID="lblNombre" runat="server" Text="Label"></asp:Label></span></h4>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="DDL_Divisiones" runat="server" CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="True">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-lg-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4">
                            <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationGroup="VDLevanEqui"
