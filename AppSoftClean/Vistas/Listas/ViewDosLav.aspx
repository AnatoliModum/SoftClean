<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewDosLav.aspx.cs" Inherits="AppSoftClean.Vistas.Listas.ViewDosLav" %>
    ...
    <div class="col-md-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                ...
                <div class="row">
                    <div class="col-lg-10">
                        <h2 style="margin-top:0px"><asp:Image ID="ImgLista" CssClass="icono" ImageUrl="~/Imagenes/dishwasher.png" runat="server" />&nbspDosificador para Lavavajillas</h2>
                    </div>
                    <div class="col-lg-1">
                ...
                <div class="form-horizontal form-label-left input_mask">
                    <asp:GridView ID="dgvDatos" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Equipo" DataField="Equipo" ItemStyle-Font-Size="10" />
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <h4>Confirme para eliminar el registro número&nbsp<span class="label label-danger"><asp:Label ID="lblID" runat="server" Text="Label"></asp:Label></span>&nbsp llamado &nbsp<span class="label label-danger"><asp:Label ID="lblEquipo" runat="server" Text="Label"></asp:Label></span></h4>
                </div>
