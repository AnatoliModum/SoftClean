    ...
    <div class="col-md-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                ...
                <div class="row">
                    <div class="col-lg-10">
                        <h2 style="margin-top:0px">Lista de Levantamientos</h2>
                    </div>
                    <div class="col-lg-1">
                    ...
                    <div class="row">
                        <div class="col-lg-4">
                            <div class="input-group">
                                ...
                                <asp:DropDownList ID="DDL_Divisiones" runat="server" CssClass="form-control" AppendDataBoundItems="true" AutoPostBack="True" OnSelectedIndexChanged="DDL_Divisiones_SelectedIndexChanged">
                                </asp:DropDownList>
                            </div>
                        </div>
                        <div class="col-lg-4">
