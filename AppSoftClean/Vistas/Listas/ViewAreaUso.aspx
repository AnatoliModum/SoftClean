<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewAreaUso.aspx.cs" Inherits="AppSoftClean.Vistas.PantallasDePrueba.ViewAreaUso" %>
    ...
    <div class="col-md-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                ...
                <div class="row">
                    <div class="col-lg-10">
                        <h2 style="margin-top:0px"><asp:Image ID="ImgLista" CssClass="icono" ImageUrl="~/Imagenes/tienda.png" runat="server" />&nbsp Área de Uso</h2>
                    </div>
                    <div class="col-lg-1">
