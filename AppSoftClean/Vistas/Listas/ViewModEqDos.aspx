<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ViewModEqDos.aspx.cs" Inherits="AppSoftClean.Vistas.Listas.ViewModEqDos" %>
    ...
    <div class="col-md-12 col-xs-12">
        <div class="x_panel">
            <div class="x_title">
                ...
                <div class="row">
                    <div class="col-lg-10">
                        <h2 style="margin-top:0px">Modelo Equipo Dosificador</h2>
                    </div>
                    <div class="col-lg-1">
                ...
                <div class="form-horizontal form-label-left input_mask">
                    <asp:GridView ID="dgvDatos" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="Modelo" DataField="Modelo" ItemStyle-Font-Size="10" />
